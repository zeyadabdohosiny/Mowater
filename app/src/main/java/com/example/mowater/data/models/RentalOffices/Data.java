...
public class Data implements Serializable {
    ...
    @SerializedName("rental_laws")
    @Expose
    private List<RentalLaw> rentalLaws = null;
    ...
    @SerializedName("rental_office_cars")
    @Expose
    private List<RentalOfficeCar> rentalOfficeCars = null;
    ...
    public List<RentalLaw> getRentalLaws() {
        return rentalLaws;
    }

    public void setRentalLaws(List<RentalLaw> rentalLaws) {
        this.rentalLaws = rentalLaws;
    }
    ...
    public List<RentalOfficeCar> getRentalOfficeCars() {
        return rentalOfficeCars;
    }

    public void setRentalOfficeCars(List<RentalOfficeCar> rentalOfficeCars) {
        this.rentalOfficeCars = rentalOfficeCars;
    }
